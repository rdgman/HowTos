...
Stop MariaDB: `service mysql stop`

Restart MariaDB: `service mysql restart`

Status MariaDB: `service mysql status`
...
Create new remote user: `CREATE USER 'username'@'%' IDENTIFIED BY 'password';`

Grant `ALL` access to user for `*` tables: `GRANT ALL ON database.* TO 'user'@'localhost';`

Grant `ALL` access to remote user for `*` tables: `GRANT ALL ON database.* TO 'user'@'%';`
